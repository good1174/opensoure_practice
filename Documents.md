...
1. Ensure your local environment is running Python 3.10.0.
2. Navigate to the project directory and locate the Opensource5.ipynb file.
3. Open the file in your preferred notebook environment.
4. Select "Run All Cells" to initiate the sequential workflow.
